...
function almacenarFactura() {
	...
	calcularTotal();
	localStorage.setItem('factura', JSON.stringify(hijos));
	console.log(JSON.parse(localStorage.getItem('factura')));
}

/**
 * función que recupera la factura del localstorage y 
...
function recuperarFactura() {
	...
	else if (!localStorage.getItem('factura')) {
		alert('No hay datos guardados!!');
	}
	else {
		let productos = JSON.parse(localStorage.getItem('factura'));
